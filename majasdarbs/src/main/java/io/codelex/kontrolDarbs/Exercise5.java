...
//    public static <E> double partOf(List<E> list, Predicate<E> function) {
//      //  List<E> filteredList = list.stream().filter(function).toList();
//        return (filteredList.size() / (double) list.size());
//    }
}
